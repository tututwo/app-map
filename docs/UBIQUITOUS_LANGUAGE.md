...
| Term            | Definition                                                                                                      | Aliases to avoid                                                  |
| --------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| **Level**       | The kind of statistical unit the map colours: state, county, ZIP, or tract.                                     | geography, geographic level, granularity, layer, view, resolution |
...
| **Tract**       | A census tract; the smallest level shown on the map.                                                            | neighborhood, census area                                         |
| **Block group** | A sub-tract Census level present in the data but not shown on the map.                                          | —                                                                 |
