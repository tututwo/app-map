...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <button 
                ...
                class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                {#if isExporting}
    ...
    <div 
        class="dashboard-content bg-white rounded-lg shadow-sm border border-gray-200 p-8" 
    ...
    >
        ...
        <div class="mb-8">
            ...
            <div class="h-[300px] border border-gray-200 rounded-lg p-4">
                <Figure>
                    <LineChart
                        {data}
        ...
        <div class="mb-8">
            ...
            <div class="h-[400px] border border-gray-200 rounded-lg overflow-hidden">
                <MapLibreMap />
            </div>
        </div>
